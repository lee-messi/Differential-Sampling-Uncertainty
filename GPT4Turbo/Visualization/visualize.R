...
dataframe = read.csv('../gpt4turbo.csv')
...
ggsave(filename = "race.pdf", width = 10, height = 4, 
...
ggsave(filename = "race_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
...
ggsave(filename = "gender_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
