...
dataframe = read.csv('../gpt4omini.csv')
...
ggsave(filename = "gpt4omini_race.pdf", width = 10, height = 4, 
...
ggsave(filename = "gpt4omini_gender.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
...
ggsave(filename = "gpt4omini_race_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
...
ggsave(filename = "gpt4omini_gender_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
