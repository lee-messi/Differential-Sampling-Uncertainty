...
dataframe = read.csv('../llama_probs.csv')
...
ggsave(filename = "llama_race.pdf", width = 10, height = 4, 
...
ggsave(filename = "llama_gender.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
...
ggsave(filename = "llama_race_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
...
ggsave(filename = "llama_gender_position.pdf", width = 10, height = 4, 
       dpi = "retina", device = cairo_pdf)
